				...
				if (!updateLatLngOnly) {
					...
					for(int i = 0; i < addressComponents.length(); i++) {
						...
						for(int t = 0; t < componentTypes.length(); t++) {
							...
							switch(type) {
							case "street_number": address.number = longValue; break;
							case "route": address.street = longValue; break;
							case "locality": address.city = longValue; break;
							case "administrative_area_level_1": address.province = longValue; break;
							case "country": address.country = shortValue; break;
							case "postal_code": address.postalCode = longValue; break;
							}
						}
					}
				}
