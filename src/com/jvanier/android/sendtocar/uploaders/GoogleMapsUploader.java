...
public class GoogleMapsUploader extends BaseUploader {
	...
	private String preparePostData() throws BackgroundTaskAbort {
		...
		try {
			...
			// full address data
			final String[] codesFull = { "lat", "lng", "street", "streetnum",
					"city", "province", "postalcode", "country", "phone",
					"notes" };
			final String[] valuesFull = {
					address.latitude,
					address.longitude,
					address.street,
					address.number,
					...
					address.postalCode,
					address.country,
					provider.internationalPhone ? address.internationalPhone
							: address.phone, notes };
